...
class FairsenseGPURuntime(FairsenseRuntime):
    ...
    def predict_with_text_model(
        ...
        """
        Generates a response using the model on GPU.
        ...
        tracker = OfflineEmissionsTracker(country_iso_code="CAN", project_name="fairsense-gpu-inference",output_dir=emissions_output_dir)
        tracker.start()
        if progress:
...
class FairsenseCPURuntime(FairsenseRuntime):
    ...
    def predict_with_text_model(
        ...
        """
        Generates a response using Ollama for model inference.
        ...
        emissions_output_dir = "./emissions"
        os.makedirs(emissions_output_dir, exist_ok=True) 
        tracker = OfflineEmissionsTracker(country_iso_code="CAN", project_name="fairsense-cpu-inference",output_dir=emissions_output_dir)
        tracker.start()
